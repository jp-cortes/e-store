 ...
 location.reload();// then will reload retun the user to the login page
  ...
  return (
    <NavigationMenu.Root className="relative w-[100px] flex justify-center items-center">
      <NavigationMenu.List className="flex justify-center items-center w-6 h-6 list-none bg-white m-0 rounded-md p-[5px] shadow-[0px_10px_38px_-10px_rgba(22,_23,_24,_0.35),_0px_10px_20px_-15px_rgba(22,_23,_24,_0.2)]">
        <NavigationMenu.Item>
          ...
          <NavigationMenu.Content className=" bg-white absolute top-0  w-full left-[-2px] sm:w-auto">
            ...
            <button
        className='w-24  p-1 md:p-2 lg:p-2 bg-green-400 text-white font-semibold rounded-md inline-block m-1 '

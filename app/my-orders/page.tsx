      ...
      <Link passHref href='/my-order' className='absolute right-0 top-2'>
        ...
        {allMyOrders?.length === 0 ? (
          <div className='flex flex-col justify-center mx-auto'>
            ...
            <Link href='/categories' className="bg-white text-center mt-10 p-2 border-2 border-green-600 text-green-600 rounded-lg hover:bg-green-600 hover:text-white">Start shopping!</Link>
